...
<template>
  <footer class="">
    ...
    <section
      class="flex item-center justify-center divide divide-accent-foreground border-b border-indigo-300/30"
    >
      <!--x-logo-->
      <NuxtLink
      ...
      <NuxtLink
        ...
        class="hover:shadow-md shadow-blue-300 transition-shadow"
      >
      ...
      <NuxtLink
        to="https://www.linkedin.com/in/suleiman-hamza-suleiman-01335a411"
        target="_blank"
    ...
    <div class="p-4">
      <p class="text-center">
        If you love this, give me a star on
        <a href="https://github.com/suleiman-hamza" class="underline text-indigo-300">Github</a> :)
      </p>
      <p class="text-center">
        Copyright @ 2026. Built with <span>&#9749;</span> <span>&#128293;</span> &
        <span>&#128156;</span>
      </p>
    </div>
  </footer>
