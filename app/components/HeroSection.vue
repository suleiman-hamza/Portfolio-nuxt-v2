...
<template>
    <section class="h-screen border-b border-gray-300/50">
        <main
            class="container flex flex-col items-center justify-between border-x border-gray-300/50 grid-background px-4 sm:px-8 sm:py-12 bg-(--foreground) text-(--text-muted) h-full">
            ...
            <h2 class="text-slate-500 text-3xl sm:text-4xl leading-[1.3] !mt-18 !mb-4 max-w-[700px] text-center">
