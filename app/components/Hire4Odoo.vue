...
<template>
    <section class="border-b border-gray-300/50">
        <section class="border-x border-gray-300/50 container py-15 px-4">
            ...
            <div class="border-amber-200/60 border p-2 md:p-4 max-w-4xl bg-amber-200/10 text-white">
                <blockquote class="mb-2 md:mb-4 text-2xl md:text-3xl">"Helping businesses showcase their value to the world throught strategic and timeless workflows with ERP Software."</blockquote>
                ...
                <Button class="rounded-none hover:cursor-pointer text-lg" variant="outline">
                    Learn More
                    <ArrowUpRight />
                </Button>
            </div>
