...
<template>
    <main class="border-b">
        <section class="container mt-17 border-[#dedede] bg-foreground) text-white sm:grid sm:grid-cols-2">
            ...
            <section class="p-4 border text-primary-foreground sm:grid-col-start-2 sm:grid-col-end-3">
                <h4 class="text-2xl mb-2">Let's Connect</h4>
                ...
                <div class="flex flex-col gap-2">
                    <NuxtLink to="https://github.com/suleiman-hamza" target="_blank" aria-label="Github Profile"
                        class="flex items-center p-2 px-3 font-light rounded-full size-fit bg-muted-foreground">
                        ...
                        <span class="text-white">@suleiman-hamza</span>
                    </NuxtLink>
                    <NuxtLink to="/contact"
                        class="flex items-center p-2 px-3 font-light rounded-full size-fit bg-muted-foreground">
                        ...
                        <span class="text-white">@thee_hamza001</span>
                    </NuxtLink>
                    <NuxtLink to="https://www.instagram.com/_suleiman_hue/" target="_blank" aria-label="Instagram Profile"
                        ...
                        <span class="text-white">@_suleiman_hue</span>
                    </NuxtLink>
                    <NuxtLink to="https://bsky.app/profile/suleiman-hue.bsky.social" target="_blank" aria-label="Bluesky Profile"
                        class="flex items-center p-2 px-3 font-light rounded-full size-fit bg-muted-foreground">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="w-auto h-full mr-2">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1.5"
                        ...
                        <span class="text-white">@suleiman-hue.bsky.social</span>
                    </NuxtLink>
            ...
            <section class="p-4 border border-purple-500">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam optio harum corporis, quaerat
                    blanditiis velit sequi architecto recusandae deserunt veritatis nulla dolorum aliquam atque eaque
                    molestias, consectetur nisi cupiditate quidem.</p>
            </section>
        </section>
    </main>
</template>
