...
useSeoMeta({
  ...
  ogDescription:
    "Odoo Technical Developer - Helping businesses showcase their value to the world throught strategic and timeless workflows with Odoo ERP",
...
const accordionList = ref([
  {
    ...
    content:
      "The cost of a project depends on many factors, such as the size of the project, the features, the development time, etc. The initial amount of my services start from $200, with an average between $500 and $1000",
    value: "item-1",
  },
  {
    title: "We want to employ you fulltime",
    content:
      "At the moment, i am not open for a fulltime role as an Odoo developer, but i can recommend other developers for you.",
    value: "item-2",
  },
  {
    title: "How does payment work for a project?",
    content:
      "I ask for a 40% deposit before starting a project, and the remaining 60% after succesful delivery. I accept payments by bank transfer (local & International), Paypal, etc..",
    value: "item-3",
  },
  {
    title: "How long is Technical support?",
    content:
      "It ranges from 3 months - 6 months, dependng on the agreed payment for that particuar project.",
    value: "item-4",
  },
]);
</script>
  ...
  <main class="">
    <div class="container py-4 md:py-10">
      ...
      <p class="text-xl md:text-xl">
        I provide full cycle odoo implementation, from requirement gathering to designing soluions,
        and ensuring smooth deployment with minimal disruption. I have a deep understanding of Odoo
        framework, backend and frontend development. By aligning Odoo with your business goals, I
        will craft ERP solutions that align perfectly with your workflow, compliance needs and
        growth goals across multiple industries
      </p>
    </div>

    <section class="container py-4 md:py-10">
      <h2 class="text-muted text-2xl md:text-3xl mb-6">
        Technologies used for Odoo ERP Development
      </h2>
        ...
        <div class="flex gap-1">
          ...
          >
            <path
              ...
              d="M4.5 4.5L1 8l3.5 3.5m7-7L15 8l-3.5 3.5M9.5 2l-3 12"
              stroke-width="1"
            />
          </svg>
        ...
        <div class="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 p-1">
          <span class="border border-gray-300/50 p-4 flex flex-col gap-4 items-center text-center">
            ...
            <p class="md:text-xl text-lg">
              Develop or extend tailored odoo modules to match your exact business process
              (Websites, Social & Email Marketing, Inventory, Journal Configuration e.t.c.)
            </p>
          </span>
          <span class="border border-gray-300/50 p-4 flex flex-col gap-4 items-center text-center">
            ...
            <p class="md:text-xl text-lg">
              Our Odoo CRM and eCommerce setups integrate your website, store, and backend -- with
              local payment gateways like Paystack and Flutterwave for seamless transactions.
            </p>
          </span>
          <span class="border border-gray-300/50 p-4 flex flex-col gap-4 items-center text-center">
            <BellPlus class="size-9" color="white" />
            <p class="text-center text-amber-200 text-xl rakkas">
              Accounting, HR & Manufacturing Automation
            </p>
            <p class="md:text-xl text-lg">
              Streamline your operations with smart automation. we digitize Accounting, HR, Payroll
              & Manufacturing workflows - by improving compliance with accounting standards.
            </p>
          </span>
          <span class="border border-gray-300/50 p-4 flex flex-col gap-4 items-center text-center">
            ...
            <p class="md:text-xl text-lg">
              Integrate Odoo with third-party APIs, banking, CRM, logistics, POS or IoT to create
              one unified business platform that keeps your entire organization connected.
            </p>
          </span>
        </div>
      </section>
    ...
    <section class="border-b border-gray-300/50">
      <div class="border-x border-gray-300/50 container">
        <div class="grid grid-cols-1 md:grid-cols-3">
          <h2
            class="text-center text-muted text-2xl md:text-3xl flex items-center justify-center p-4 rakkas"
          >
            FAQ
          </h2>
          <div class="md:col-span-2 border-t md:border-t-0 border-gray-300/50 md:border-l">
            <Accordion type="single" collapsible class="w-full">
              <AccordionItem
                ...
                :value="item.value"
              >
                <AccordionTrigger class="px-4 text-indigo-300 text-lg">{{
                  item.title
                }}</AccordionTrigger>
